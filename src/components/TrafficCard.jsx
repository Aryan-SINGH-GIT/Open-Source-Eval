...
const TrafficCard = ({ city = "Mumbai" }) => {
  ...
  const delayMinutes = Math.round(
    (traffic.currentTravelTime - traffic.freeFlowTravelTime) / 60
  );
  ...
  return (
    <div className="traffic-card">
      <div className="traffic-header">
        ...
        <button onClick={fetchTraffic} className="refresh-btn">
          🔄
        </button>
      </div>
      ...
      <div className="traffic-main">
        <div
          ...
          style={{ borderColor: congestion.color }}
        >
          ...
          <div className="congestion-percentage">
            {congestion.percentage}% of normal speed
          </div>
        </div>
      </div>
      ...
      <div className="traffic-details">
        ...
        <div className="detail-item">
          ...
          <span className="value">
            {delayMinutes > 0 ? `+${delayMinutes} min` : "No delay"}
          </span>
        </div>
        <div className="detail-item">
